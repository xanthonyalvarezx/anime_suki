...
class searchMangaForm(forms.Form):
    ...
    searchText = forms.CharField(
      max_length=300,
      widget=forms.TextInput(attrs={'class':'form-control', 'placeholder': 'Search Manga by Title'}),
      label=''
      )
class searchAnimeForm(forms.Form):
    ...
    searchText = forms.CharField(
      max_length=300,
      widget=forms.TextInput(attrs={'class':'form-control', 'placeholder': 'Search Anime by Title'}),
      label=''
      )